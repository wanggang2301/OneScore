 ...
 * @data: 2016/9/5 16:48
 */
public class BaskballVideoFragemnt extends Fragment implements View.OnClickListener,SwipeRefreshLayout.OnRefreshListener{
    ...
    public static BaskballVideoFragemnt newInstance(int index) {
        Bundle bundle = new Bundle();
        bundle.putInt(FRAGMENT_INDEX, index);
        BaskballVideoFragemnt fragment = new BaskballVideoFragemnt();
