 ...
 * 描述：篮球 欧赔亚盘 大小球
 */
public class BasketOddsAsiaSizeFragment extends BasketDetailsBaseFragment<ObservableListView> {
    ...
    public BasketOddsAsiaSizeFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTitleGuestWin= (TextView) view.findViewById(R.id.basket_odds_guest_win);
        mTitleGuestWin.setText("大球");
        mTitleHomeWin= (TextView) view.findViewById(R.id.basket_odds_home_win);
        mTitleHomeWin.setText("小球");
