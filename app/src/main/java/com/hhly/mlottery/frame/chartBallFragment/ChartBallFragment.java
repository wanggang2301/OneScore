                        ...
                        if (i != 0) {
                            try {
                                ...
                                if (currentTime - lastTime >= SHOW_TIME_LONG_FULL) {
                                    ...
                                    historyBeen.get(i).setTime(DateUtil.convertDateToNationHMS(historyBeen.get(i).getTime()));
                                ...
                                try {
                                    if (historyBeen != null && historyBeen.size() > 1) {
                                        ...
                                        if (currentTime - lastTime >= SHOW_TIME_LONG_FULL) {
                                            ...
                                            chartbean.setTime(DateUtil.convertDateToNationHMS(chartRoom.getData().getTime()));
                                        } else if (currentTime - lastTime >= SHOW_TIME_LONG) {
                                            // 显示时分秒
                                        ...
                                        if (i != 0) {
                                            try {
                                                ...
                                                if (currentTime - lastTime >= SHOW_TIME_LONG_FULL) {
                                                    // 显示年月日
                                                    historyBeen.get(i).setShowTime(currentTime - lastTime >= SHOW_TIME_LONG_FULL);
                                                    historyBeen.get(i).setTime(DateUtil.convertDateToNationHMS(chartRoom.getData().getTime()));
                                                } else if (currentTime - lastTime >= SHOW_TIME_LONG) {
                                                    // 显示时分秒
                                                    historyBeen.get(i).setShowTime(currentTime - lastTime >= SHOW_TIME_LONG);
