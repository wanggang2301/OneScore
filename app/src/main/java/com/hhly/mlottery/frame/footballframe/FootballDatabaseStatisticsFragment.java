...
//            awayPre = 100.00-homePre-equalPre;
    ...
    class MostAdapter extends CommonAdapter<TopDetailsBean>{
        ...
        boolean isDEF;//是否是防守项

        public MostAdapter(Context context, List<TopDetailsBean> datas, int layoutId , boolean isSPFMost , boolean isDef) {
        ...
        public void convert(ViewHolder holder, TopDetailsBean basketDatabaseMostDat) {
            ...
            if (isSPF) {
                ...
                if (isDEF) {
                    holder.setText(R.id.football_database_most_item_avg_num , getResources().getString(R.string.football_database_details_most_lost_score_avg));
                }else{
