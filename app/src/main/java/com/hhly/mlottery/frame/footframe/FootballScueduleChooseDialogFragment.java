 ...
 * 足球资料库赛程多级Adapter
 */
public class FootballScueduleChooseDialogFragment extends DialogFragment {
    ...
    public static FootballScueduleChooseDialogFragment newInstance(ScheduleResult result) {

        Bundle args = new Bundle();
        args.putParcelable(KEY_RESULT, result);
        FootballScueduleChooseDialogFragment fragment = new FootballScueduleChooseDialogFragment();
