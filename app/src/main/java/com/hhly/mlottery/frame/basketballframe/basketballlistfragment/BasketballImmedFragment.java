package com.hhly.mlottery.frame.basketballframe.basketballlistfragment;
 ...
 */
public class BasketballImmedFragment extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, ExpandableListView.OnChildClickListener {
     ...
     * @return
     */
    public static BasketballImmedFragment newInstance(int basketballType, boolean isNewFramWork, int basketEntryType) {
        BasketballImmedFragment fragment = new BasketballImmedFragment();
...
//                    adapter.setmFocus(mFocusClickListener);//设置关注//TODO*************关注点击监听*******************
                } else {
                    updateAdapter();
                }
                /**
