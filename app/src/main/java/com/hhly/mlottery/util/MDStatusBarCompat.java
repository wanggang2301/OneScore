...
public class MDStatusBarCompat {
    ...
    public static void setOrdinaryToolBar(Activity activity) {
        setOrdinaryToolBar(activity, R.color.black);
    }
     ...
     * @param colorRes
     */
    public static void setOrdinaryToolBar(Activity activity, @ColorRes int colorRes) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            activity.getWindow().setStatusBarColor(ContextCompat.getColor(activity, R.color.black));
        } else if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
            setKKStatusBar(activity, colorRes);
        }
    }
    ...
    public static void setCollapsingToolbar(Activity activity, CoordinatorLayout coordinatorLayout,
                                            AppBarLayout appBarLayout, View view, Toolbar toolbar) {
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
