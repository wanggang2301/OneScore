 ...
 * 时间:  2016/9/7 10:45
 */
public class LeagueStatisticsTodayFlatSmallToBigComparator implements Comparator<LeagueStatisticsTodayChildBean> {

    @Override
    public int compare(LeagueStatisticsTodayChildBean o1, LeagueStatisticsTodayChildBean o2) {

        int compare = 0;
        compare = Integer.parseInt(o1.getDrawPercent()) - Integer.parseInt(o2.getDrawPercent());//小到大排序
        if (compare == 0) {
