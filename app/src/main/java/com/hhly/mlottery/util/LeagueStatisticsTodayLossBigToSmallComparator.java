 ...
 * 时间:  2016/9/7 10:58
 */
public class LeagueStatisticsTodayLossBigToSmallComparator  implements Comparator<LeagueStatisticsTodayChildBean> {

    @Override
    public int compare(LeagueStatisticsTodayChildBean o1, LeagueStatisticsTodayChildBean o2) {

        int compare = 0;
        compare = Integer.parseInt(o2.getLostPercent()) - Integer.parseInt(o1.getLostPercent());//先按msgid排序
        if (compare == 0) {
