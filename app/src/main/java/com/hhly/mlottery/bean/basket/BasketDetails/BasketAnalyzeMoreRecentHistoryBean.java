...
public class BasketAnalyzeMoreRecentHistoryBean {
    ...
    private String concede; //	+12.5
    private String date;//	16-02-13
    private String guestTeam;//	维多利亚
    private String highLow;//	1
    private boolean homeGround;//	false
    private String homeTeam;//	莫日达斯克鲁济斯
    private String leagueName;//	巴西甲
    private int result;//	0
    private String score;//	77:84
