...
//    public final static String URL_FOOTBALL_DATABASE_SCHEDULE_FIRST = "http://192.168.31.8:8080/mlottery/core/androidLeagueData.findAndroidLeagueRound.do";
    public final static String URL_FOOTBALL_DATABASE_SCHEDULE_FIRST = URL_API_HOST + "androidLeagueData.findAndroidLeagueRound.do";
//    public final static String URL_FOOTBALL_DATABASE_SCHEDULE_UNFIRST = "http://192.168.31.8:8080/mlottery/core/androidLeagueData.findAndroidLeagueRace.do";
    public final static String URL_FOOTBALL_DATABASE_SCHEDULE_UNFIRST = URL_API_HOST + "androidLeagueData.findAndroidLeagueRace.do";
    //足球资料库积分
//    public final static String URL_FOOTBALL_DATABASE_INTEGRAL_FIRST = "http://192.168.31.8:8080/mlottery/core/androidLeagueData.findAndroidLeagueScore.do";
    public final static String URL_FOOTBALL_DATABASE_INTEGRAL_FIRST = URL_API_HOST + "androidLeagueData.findAndroidLeagueScore.do";
