...
/**
 * 
 * @ClassName: XRTextView 
 * @Description: 字体两边对齐
 * @author Tenney
 * @date 2015-12-21 上午10:42:59
 */
public class XRTextView extends TextView{ 
 ...
 public XRTextView(Context context, AttributeSet attrs) { 
  ...
  textSize = attrs.getAttributeIntValue(namespace, "textSize", DisplayUtil.dip2px(context, 15));//字体大小
  textColor = attrs.getAttributeIntValue(namespace, "textColor",context.getResources().getColor(R.color.res_name_color));//字体颜色
  ...
  marginRight = attrs.getAttributeIntValue(namespace, "marginRight", 60);
