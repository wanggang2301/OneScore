...
/**
 * 描    述：提供WebSocket功能的Fragment基类
 * 作    者：chenml@13322.com
 * 时    间：2016/6/27
 */
public abstract class BaseWebSocketFragment extends Fragment {
...
//                            L.d(TAG, "after connect ws.getState() = " + ws.getState());
    ...
    public class MyWebSocketAdapter extends WebSocketAdapter {
        ...
        public void onConnected(WebSocket websocket, Map<String, List<String>> headers) throws Exception {
            ...
            BaseWebSocketFragment.this.onConnected();
        }
...
//            L.d(TAG, "cause" + cause.getMessage());
        ...
        public void onDisconnected(WebSocket websocket, WebSocketFrame serverCloseFrame, WebSocketFrame clientCloseFrame, boolean closedByServer) throws Exception {
            ...
            BaseWebSocketFragment.this.onDisconnected();
        }
