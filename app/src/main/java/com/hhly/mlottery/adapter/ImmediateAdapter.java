...
public class ImmediateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImmediateAdapter(Context context, List<Match> datas, String teamLogoPre, String teamLogoSuff) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_football, viewGroup, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        convert((ImmediaViewHolder) holder, match, handicap);
    }
    ...
    private void convert(final ImmediaViewHolder holder, final Match match, int handicap) {
