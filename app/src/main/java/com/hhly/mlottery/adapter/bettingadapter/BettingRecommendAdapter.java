...
public class BettingRecommendAdapter extends BaseQuickAdapter<String> {

    private Context mContext;
    private List<String> mData;

    public BettingRecommendAdapter(Context context, List<String> data) {
     ...
     * 购买（查看）监听
     */
    private BettingRecommendActivity.BettingBuyClickListener mBuyClick; //关注监听回掉
    public void setmBuyClick(BettingRecommendActivity.BettingBuyClickListener mBuyClick) {
        this.mBuyClick = mBuyClick;
    }
    /**
     * 专家详情监听
     */
    private BettingRecommendActivity.BettingSpecialistClickListener mSpecialistClick; //关注监听回掉
    public void setmSpecialistClick(BettingRecommendActivity.BettingSpecialistClickListener mSpecialistClick) {
     ...
     * 内页详情监听
     */
    private BettingRecommendActivity.BettingGameDetailsClickListener mGameDetailsClick;
    public void setmGameDetailsClick(BettingRecommendActivity.BettingGameDetailsClickListener mGameDetailsClick){
