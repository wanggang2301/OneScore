 ...
 */
public class PinnedHeaderExpandableResultAdapter extends BaseExpandableListAdapter implements HeaderAdapter {
...
//	private BasketOddsBean MatchOdds;
    ...
    private ResultBasketballFragment.BasketFocusClickListener mFocus; //关注监听回掉

    public void setmFocus(ResultBasketballFragment.BasketFocusClickListener mFocus) {
        this.mFocus = mFocus;
    }
...
//    private ImageLoader.ImageCache mImageCache;
    ...
    public PinnedHeaderExpandableResultAdapter(List<List<BasketMatchBean>> childrenDataList, List<String> groupDataList
...
//					holder.basket_all_score.setTextColor(Color.BLACK);
                    holder.basket_score.setText("");
                    holder.basket_no_start.setVisibility(View.VISIBLE);
//                    holder.basket_score.setTextSize(TypedValue.COMPLEX_UNIT_PX,mContext.getResources().getDimension(R.dimen.text_size_12));
//                    holder.basket_score.setBackgroundColor(Color.WHITE);// -------设置背景色 (防止背景复用比分)-------
                    holder.basket_score.setTextColor(mContext.getResources().getColor(R.color.basket_vs));
                    holder.basket_guest_all_score.setText("");
                    holder.basket_home_all_score.setText("");
