 ...
 */
public class PinnedHeaderExpandableFocusAdapter extends BaseExpandableListAdapter implements HeaderAdapter {
...
//	private BasketOddsBean MatchOdds;
    ...
    private FocusBasketballFragment.BasketFocusClickListener mFocus; //关注监听回掉

    public void setmFocus(FocusBasketballFragment.BasketFocusClickListener mFocus) {
        this.mFocus = mFocus;
    }
...
//    private ImageLoader.ImageCache mImageCache;
    ...
    public PinnedHeaderExpandableFocusAdapter(List<List<BasketMatchBean>> childrenDataList, List<String> groupDataList
