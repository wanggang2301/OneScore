...
//                viewHolderDate.mDate.setText("2016-12-05 ");
                viewHolderDate.mDate.setText(riqiData.getDate());
                viewHolderDate.mWeek.setText("");
//                viewHolderDate.mDay.setText("Today");
    ...
    private void setItemData(final ViewHolderItem holder , CustomMineThirdDataBean data){
            ...
            if (MatchOdds != null) {
                ...
                boolean asize = PreferenceUtil.getBoolean(MyConstants.BASKETBALL_CUSTOM_rbSizeBall, false); //大小球
                boolean eur = PreferenceUtil.getBoolean(MyConstants.BASKETBALL_CUSTOM_RBOCOMPENSATE, false);//欧赔
                boolean alet = PreferenceUtil.getBoolean(MyConstants.BASKETBALL_CUSTOM_RBSECOND, true); //亚盘
                boolean noshow = PreferenceUtil.getBoolean(MyConstants.BASKETBALL_CUSTOM_RBNOTSHOW, false);//不显示
...
//        TextView mDay;
        ...
        public ViewHolderDate(View itemView) {
            ...
            mWeek = (TextView) itemView.findViewById(R.id.basketball_xingqi);
//            mDay = (TextView) itemView.findViewById(R.id.basketball_current_day);
...
//            mLogo = (ImageView) itemView.findViewById(R.id.custom_league_logo);
