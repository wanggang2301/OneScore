...
import com.hhly.mlottery.callback.InfoCenterSearchservice;
...
public class InfoCenterSearchActivity extends BaseActivity implements  View.OnClickListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        final InfoCenterSearchservice service = retrofit.create(InfoCenterSearchservice.class);
        //保存数据源
        ...
        mTv_result.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if( null!=resultListBeen.get(position).getLeagueId()&&!resultListBeen.get(position).getLeagueId().isEmpty()) {
                    Intent intent = new Intent(InfoCenterSearchActivity.this, BasketballDatabaseDetailsActivity.class);
