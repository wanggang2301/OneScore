...
public class DebugConfigActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/***/
		//开发环境
	/*	findViewById(R.id.config_rb3).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				((RadioGroup)findViewById(R.id.config_rg1)).check(R.id.config_rb5);
			}
		});
		//测试环境
		findViewById(R.id.config_rb6).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				((RadioGroup)findViewById(R.id.config_rg1)).check(R.id.config_rb1);
			}
		});
		//生产环境
		findViewById(R.id.config_rb4).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				((RadioGroup)findViewById(R.id.config_rg1)).check(R.id.config_rb2);
			}
		});*/
